...
<?php
    ...
    if(isset ($_POST['btnins']))
    {
        ...
        $q=mysqli_query($con, "insert into offer values(null,'$oname',$pid ,'$description','$percentage','$ostartdate','$oendsdate')");
		//<!--echo "insert into offer values(null,'$oname',$pid ,'$description',$percentage,'$ostartdate','$oendsdate')";-->
        if($q)
        echo "inserted";
        else
            echo "not inserted";
...
?>
<center><a href="" class="previous round"><b>&#8249; previ </b></a><b style="color:black;font-size:20px;">OFFER DATA</b><a href="" class="Next round"><b>Next &#8250;</b></a></center>
<form method = POST  >
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="editor1" placeholder="" class="col-xs-10 col-sm-5" name=txtdescription required />
