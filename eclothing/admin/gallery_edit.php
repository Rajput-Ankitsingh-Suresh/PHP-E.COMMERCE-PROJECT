...
include('conn.php');
$gid = $_GET['x'];
$q=mysqli_query($con,"select * from gallery where gid=$gid");
...
if(isset ($_POST['btnup']))
{
    ...
    $q=mysqli_query($con, "update gallery set pic='$pic' where gid=$gid");
    if($q)
        echo "updated";
    else
        echo "not updated";
...
?>
<!--  <h1 ALIGN=CENTER>GALLERYEDIT</H1> -->
<center><a href="" class="previous round"><b>&#8249; previ </b></a><b style="color:black;font-size:20px;">GALLERYEDIT</b><!--<a href="" class="Next round"><b>Next &#8250;</b></a>--></center>
