...
if(isset($_POST['btnins']))
{
    ...
    $q=mysqli_query($con,"insert into subcategory values(null,$cid,'$sname','$pic')");
    if($q)
      echo "inserted";
    else
      echo "not inserted";  
...
<center><a href="" class="previous round"><b>&#8249; previ </b></a><b style="color:black;font-size:20px;">SUBCATEGORY</b><a href="" class="Next round"><b>Next &#8250;</b></a></center>
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" name=txtsname required  />
										</div>
									</div><br>
 
<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Subcategorypic</label>
