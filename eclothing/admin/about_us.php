...
if(isset($_POST['btnins']))
{
    ...
    $q=mysqli_query($con,"insert into about_us values(null,'$usertitle','$userdescription')");
    if($q)
      echo "inserted";
    else
      echo "not inserted";  
...
?>
<!--<H1 ALIGN=CENTER> ABOUTUS </b></u></H1>-->
<center><a href="" class="previous round"><b>&#8249; previ </b></a><b style="color:black;font-size:20px;">About US</b><a href="" class="Next round"><b>Next &#8250;</b></a></center>
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" name=txtusertitle required />
										</div>
									</div><br>
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" name=txtuserdescription required />
										</div>
									</div><br>
