...
if(isset($_POST['btnins']))
{
    ...
    $q=mysqli_query($con,"insert into category values(null,'$cname','$pic')");
    if($q)
      echo "inserted";
    else
      echo "not inserted";  
...
<center><a href="" class="previous round"><b>&#8249; previ </b></a><b style="color:black;font-size:20px;">CATEGORY</b><a href="" class="Next round"><b>Next &#8250;</b></a></center>
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" name=txtcname required />
										</div>
									</div><br>
