			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="#" class="active" id="login-form-link">Retrieve Password</a>
							</div>
							<!--<div class="col-xs-6">
...
if(isset($_POST['submit']))
{
    ...
    $emailquery = "select * from userregistration where  email = '$email'";
	...
	if($emailcount){
        ...
        $body = "Hi, $username. click here too reset your Password http://localhost/eclothing/user/reset_password.php?uid=$uid";
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Send Mail">
											</div>
										</div>
									</div>
									<div class="form-group">
