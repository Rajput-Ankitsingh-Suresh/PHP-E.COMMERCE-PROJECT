...
<!-- Mirrored from portotheme.com/html/molla/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Feb 2022 07:42:47 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="aboutus1.1.php" class="sf-with-ul">About</a>
                                        ...
                                        <li>
                                            <a href="contact us.php" class="sf-with-ul">Contact</a>
        ...
        <main class="main">
            <div class="intro-slider-container mb-0">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav": false, "dots": false}'>
                    <div class="intro-slide" style="background-image: url(assets/images/demos/demo-6/slider/slide-1.jpg);"><!--background-image:url(assets/images/demos/demo-5/slider/slide-1.jpg);-->
            ...
            <div class="container">
                <div class="heading heading-center mb-3">
                    ...
                    <!--<ul class="nav nav-pills justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                       <?php
                        echo "<a class='nav-link' href='sub_cat.php?x=$row[0]' >$row[1]</a>";

                        //echo "<a class='nav-link' id='trendy-women-link' data-toggle='tab' href='sub_cat.php' role='tab' aria-controls='trendy-women-tab' aria-selected='false'>$row[1]</a>";
                        ?>
                        </li>
                        <?php
                         }
        ...
        <?php
         ...
         ?> 
          <div class="col-lg-4">
            <div class="card">
              <?php
             echo " <img src='../admin/images/$row[2]'  height=200 width=300>";?>
              <div class="card-body">
                ...
                <?php
                   echo "<a href='sub_cat.php?x=$row[0]' class='btn btn-primary' >$row[1]</a>";
                ?>
              </div>
            </div>
          </div>
                            ...
                            <div class="cta-wrapper cta-text text-center">
                                ...
                                <div class="social-icons social-icons-colored justify-content-center">
                                   <!-- <a href="#" class="social-icon social-facebook" title="Facebook" target="_blank"><i class="icon-facebook-f"></i></a>
                                    ...
                                    <a href="https://wa.me/918488807554" class="social-icon social-whatsapp" title="whatsapp" target="_blank"><i class="icon-whatsapp"></i></a>
                                </div><!-- End .soial-icons -->
                            </div><!-- End .cta-wrapper -->
                        </div><!-- End .col-lg-6 -->
...
<!-- Mirrored from portotheme.com/html/molla/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Feb 2022 07:42:50 GMT -->
</html>