...
<main class="main">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="product-gallery">
                                            <figure class="product-main-image">
                                                ...
                                                <?php
                                                echo " <img id='product-zoom' src='../admin/images/$row[8]'  data-zoom-image='../admin/images/$row[7]' ><br>";
                                                 ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-details product-details-sidebar">
                                            <h1 class="product-title"><?php echo $row[2] ?></h1><!-- End .product-title -->
                                            ...
                                            <div class="product-details-action">
                                                <div class="details-action-col">
                                                   ...
                                                   <div class="product-details-quantity">
                                                        ...
                                                        <input type="number" id="qty" class="form-control" value="<?php echo $row[5] ?>" required>
                                                ...
                                                <!--<div class="details-action-wrapper">-->
                                                    ...
                                                    <a href="#" class="btn-product btn-compare" title="Compare"><span>Add to Compare</span></a></br>-->
                                                    <?php
                                                    echo "<a href='hidden.php?x=$row[0]' class='btn-product btn-cart'><span>add to cart</span></a>";
                                                    ?>
         ...
         ?>       <div class="product product-sm">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                   <!-- <img src="assets/images/products/single/sidebar/1.jpg" alt="Product image" class="product-image">-->
                                                    <?php echo " <img src='../admin/images/$row[pic]' class='product-image'>";?>
                                                </a>
                                            </figure>
                                            ...
                                            <div class="product-body">
                                                <h5 class="product-title"><?php echo "<a href='sub_cat.php?x=$row[0]'>$row[2]</a>";?></a></h5><!-- End .product-title -->
                                                <!--<div class="product-price">
